...
#ifndef LAB3_SIMPLY_PARALLEL_COLUMNPARALLELMATRIXMULTIPLIER_HPP
#define LAB3_SIMPLY_PARALLEL_COLUMNPARALLELMATRIXMULTIPLIER_HPP
...
class ColumnParallelMatrixMultiplier : public IParallelMatrixMultiplier<size> {
protected:
...
public:
    ColumnParallelMatrixMultiplier(const char *leftFilename,
...
#endif //LAB3_SIMPLY_PARALLEL_COLUMNPARALLELMATRIXMULTIPLIER_HPP
